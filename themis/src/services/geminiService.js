...
* documentSummary: 사진 속 문서의 종류와 핵심 내용을 1~2 문장으로 요약합니다. 사용자가 선택한 유형과 실제 문서가 다를 경우, 실제 문서 유형을 명시하세요. (예: "프리랜서 용역 계약서로 보입니다. 계약 유형을 '프리랜서'로 변경하고 다시 시도해 보세요."). 문서를 읽을 수 없으면 왜 못 읽었는지(흐림/잘림/조명 등) 구체적으로 서술
...
function buildResult(parsed) {
  ...
  return { summary, items, documentSummary };
}
